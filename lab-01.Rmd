...
NA stands for 'not available', and I am getting this answer when attempting to calculate the mean and median because there are some values in the column n_2021 that are NA, and if the value is unknown then any calculation using that value will also be unknown.
...
The mean number of visitors is larger than the median likely due to these tourist attractions being closed on some days and having less visitors during the weekdays because of people being busy with school or work, but having a great number of visitors on the other days (weekends or school holidays, for example). 
